            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6" data-aos="fade-left">
                        ...
                        <div class="description letter-spacing-n074 fs-18 text-light-grey line-height-9"><?= $section_1['description'] ?></div>
                        <div class="price text-orange letter-spacing-n074 fw-900 fs-10 line-height-1">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6" data-aos="fade-right">
                        ...
                        <div class="description letter-spacing-n074 fs-18 text-light-grey line-height-9"><?= $section_2['description'] ?></div>
                        <div class="price text-orange letter-spacing-n074 fw-900 fs-10 line-height-1">
                            <div class="tab-content" id="v-pills-tabContent">
                                <?php
                                if (have_rows('section_2')) :
