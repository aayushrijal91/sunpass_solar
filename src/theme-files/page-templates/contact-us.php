    ...
    <div class="container">
        <div class="row gy-5">
            <div class="col-lg-6 col-xl-5" data-aos="fade-right">
                ...
                <div class="heading text-secondary fw-900 fs-7 lh-10 py-5">Make a Booking Today. <span class="fw-400">Simply fill in the form below &amp; we'll get back to you as soon as possible.</span></div>
                <div class="row align-items-center py-4 pt-lg-7 pb-lg-6">
                    ...
                    <div class="col-auto text-secondary fs-12 fw-700 lh-1"><?= get_field('phone_number', 'options') ?></div>
                </div>
                <div class="row align-items-center">
                    <div class="col-auto col-md-1">
