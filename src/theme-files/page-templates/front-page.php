        ...
        <div class="container">
            <div class="row align-items-center gy-4 gy-md-5 gy-lg-0">
                <div class="col-12 col-md">
                    ...
                    <div class="description pt-4 pt-md-5 text-white fs-21 line-height-2">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-11">
                        <div class="row gy-5 gy-lg-0 justify-content-end">
                            ...
                            <div class="col-lg-6"><img src="<?= $section_2_1['image']['url'] ?>" alt="<?= $section_2_1['image']['alt'] ?>"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="section_2_5">
            ...
            <div class="container">
                <div class="row align-items-center gy-4 gy-md-0 gx-xl-5">
                    <div class="col-md-6 col-lg-5"><img src="<?= $section_2_5['image']['url'] ?>" alt="<?= $section_2_5['image']['alt'] ?>"></div>
                    <div class="col">
        ...
        <div class="container">
            ...
            <div class="row gy-4 gy-lg-0">
                <div class="col-lg-6 col-xl-7">
                    <div class="fs-3 fw-700 letter-spacing-n23 line-height-4 pb-4 pb-lg-6"><?= $section_3['title'] ?></div>
                    <div class="d-flex">
        ...
        <div class="container">
            <div class="row gy-4 gy-lg-0">
                <div class="col-lg-6">
                    ...
                    <div class="row pt-4 pt-lg-5 pt-xl-6">
                        <div class="col-auto">
