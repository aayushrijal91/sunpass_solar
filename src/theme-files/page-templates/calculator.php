<?php
/*
 * Template Name: Rebate Calculator
 * Rebate Calculator page
 *
 */
get_header();
...
<div class="calculator_page">
    <div class="container" data-aos="fade-up">
        <div class="row justify-content-center">
            <div class="col-xl-11">
                <div class="text-center text-secondary fs-40 lh-1">System Calculator</div>
                <hr>
            </div>
            <div class="col-lg-8">
                        ...
                        <div class="col-lg-6" data-aos="fade-right">
                            <div class="row justify-content-end">
                                <div class="col-xxl-10">
                                    <div class="heading text-dark text-capitalize fw-900 fs-80 letter-spacing-n212 lh-1"><?= $section_1['title'] ?></div>
