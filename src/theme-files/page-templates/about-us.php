            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg" data-aos="fade-left">
                        <div class="fs-27 text-light-grey lh-5 fw-600">
            ...
            <div class="container">
                ...
                <div class="row gy-4 gy-lg-0">
                    <div class="col-lg-5" data-aos="fade-right">
                        <div class="fs-45 fw-700 letter-spacing-n23 lh-6 pb-4 pb-lg-6 text-orange"><?= $section_4['title'] ?></div>
                        <div class="row">
                            <div class="col-auto">
                    ...
                    <div class="col-lg" data-aos="fade-left">
                        <div class="fs-23 text-light-grey lh-7 letter-spacing-n074">
